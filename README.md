...
- **Dynamic SePay Sync & Admin Overrides (v0.9.1):** Added dynamic transaction sync settings (default limit & history days), administrative sync overrides with customizable parameters, and strict accountant role access constraints.
